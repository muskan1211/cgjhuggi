...
#signupForm label.error {
     ...
     $cityquery = "SELECT DISTINCT(CITY) as CITY FROM `tbl_client`";
        ...
        <option value="<?php echo $getcity['CITY']; ?>"><?php echo $getcity['CITY'];?></option>
            ...
            <script type="text/javascript">
              $('#cities').on("change",function(){
                var city = $('#cities').val();
                if(city!=0) {
                 $.post('getward.php',{city:city}, function(data) {
              ...
              <script type="text/javascript">
                 $('#cgfloor').on("change",function() {
                  ...
                  $('#cffloor').on("change",function() {
                        ...
                        var g = parseInt($('#cffloor').val());
                        document.getElementById('ffloorcost').value=(g*8500);
                        var f = parseInt($('#cgfloor').val());
                        var ffcost = g*8500;
                        var gfcost = parseInt($('#gfloorcost').val());
                        document.getElementById('ctotal').value=(g+f);
                        document.getElementById('floortotal').value=(gfcost+ffcost);
                        var t = parseInt($('#floortotal').val());
                        var cal = (0.25)*t;
         ...
         $.post('savebill.php?add=' + 1,$('#billForm').serialize(), function(data) {
          ...
          var obj = $.parseJSON(data);
           ...
           var city = obj.CITY;
            ...
            window.location = 'bill_dongargarh.php?id='+id;
          }
          else if(city=='Durg') {
            ...
            window.location = 'bill.php?id='+id;
              ...
              window.location = 'bill_bhilai.php?id='+id;
...
?>
 ...
 $(document).ready(function() {
    ...
    $("#report").on("submit", function(event) {
       ...
       $.post('getfilterdata.php',$(this).serialize(), function(data) {
