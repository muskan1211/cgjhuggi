...
#signupForm label.error {
      ...
      <table id="client_table" width="100%">
        ...
        $query = "SELECT * FROM `tbl_client_pmy2` where DELETE_STATUS=0";
        ...
        ?> 
			   <tr>
                ...
                <td><?php echo $row['KHASRA_NO']; ?></td>
                <td><?php echo $row['LAND_TYPE_USE']; ?></td>
                <td><?php echo $row['PLOT_AREA']; ?></td>
                <td><?php echo $row['ROAD_WIDTH']; ?></td>
                <td><?php echo $row['LAND_OWNER_TYPE']; ?></td>
                <td><?php echo $row['EXISTING_INFRA_CONDITION']; ?></td>
                <td><?php echo $row['EXISTING_INFRA_CONDITION2']; ?></td>
                <td><?php echo $row['PUCCA_TOILET_AVAILAIBILITY']; ?></td>
                <td><?php echo $row['PROPOSED_TOILET_DRAINING']; ?></td>
                <td><?php echo $row['PROPOSED_G_FLOOR_AREA'];?></td>
                <td><?php echo $row['PROPOSED_F_FLOOR_AREA'];?></td>
                <td><?php echo $row['PROPOSED_TOTAL_FLOOR_AREA'];?></td>
                <td><?php echo $row['COST_GFLOOR'];?></td>
                <td><?php echo $row['COST_FFLOOR'];?></td>
                <td><?php echo $row['COST_TOTAL'];?></td>
                <td><?php echo $row['CENTRAL_GRANT'];?></td>
                <td><?php echo $row['STATE_SHARE'];?></td>
                <td><?php echo $row['BENEFICIARY_SHARE'];?></td>
                <td>&nbsp; &nbsp;<a class="teal-text" href="javascript:editRow(<?php echo $row['id']?>);"  title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                <td>&nbsp; &nbsp;<a href="javascript:makeBill(<?php echo $row['id']?>,'<?php echo $row["NAME"]; ?>');"><i class="fa fa-user-plus" aria-hidden="true"></i></a></td>
                <td>&nbsp; &nbsp;<a href="javascript:confirmdelete(<?php echo $row['id']?>);"><i class="fa fa-times" aria-hidden="true"></i></a></td>
</td>
            </tr>
            <?php 
            $x++;
    ...
    <div><button onclick="exporttable()">Export</button></div>
    <script type="text/javascript">
      ...
      var uid = id;
        var name=name;
        $.post('getbill.php',{id:uid}, function(data) {
