...
$sanctionamt = intval($getuser2['STATE_SHARE'])+intval($getuser['CENTRAL_GRANT']);
 ...
 $installment_data = $_SESSION['installment'];
   ...
   $i=0;
     ...
     for($i=0;$i<strlen($installment_data);$i++){
        ...
        if($_SESSION['installment']=='DISMANTLED/PLINTH') {



            $garea = $getuser['PROPOSED_G_FLOOR_AREA'];
            $farea = $getuser['PROPOSED_F_FLOOR_AREA'];
    ...
    if($farea==0.00){
                ...
                if($farea==9.00 && $garea==21.00) {


                    $amount_paid = 56000;
                }
                elseif ($farea==9.00 && $garea==20.00)  {

                    $amount_paid = 55250;
                }
                elseif ($farea==12.00 && $garea==18.00) {

                    $amount_paid = 55500;
                }
                elseif ($farea==11.00 && $garea==18.00) {

                    $amount_paid = 55500;
                }
                elseif ($farea==15.00 && $garea==15.00) {

                    $amount_paid = 55250;
                }
                elseif ($farea==14.00 && $garea==15.00) {

                    $amount_paid = 54750;
                }
                elseif ($farea==14.00 && $garea==14.00) {

                    $amount_paid = 54000;
                }
                elseif ($farea==13.00 && $garea==14.00) {

                    $amount_paid = 53500;
                }
                elseif ($farea==12.50 && $garea==12.50) {

                    $amount_paid = 52250;
                }
                elseif ($farea==11.50 && $garea==12.50) {
        ...
        if($_SESSION['installment']=='LINTEL' || $_SESSION['installment']=='GFLOOR_SSLAB') {
...
if($_SESSION['installment']=='SLAB' || $_SESSION['installment']=='FFLOOR_SLAB') {
...
if($_SESSION['installment']=='COMPLETION') {
...
<body style="margin: 0px;padding: 0px;">
	<div class="container" style="margin: 0px;padding: 0px;">
		...
		<div class="content" style="margin: 20px;height:1000px;">
			<div class="header"><center><h2>AVINASH JAIN AND ASSOCIATES<BR>ER. AVINASH JAIN<br>ER. AMARPREET SINGH BHATIA </h2>
			<h4>CONSULTANT DONGARGARH MUNICIPAL COUNCIL</h4>
			<h5>REGISTERED CIVIL ENGINEER PUBLIC WORKS DEPARTMENT,WATER RESOURCES DEPARTMENT<br>
STRUCTURE REPAIR REHABILATION,WATER PROOFING SYSTEMS,SELANTS FLOORINGS & MATERIALS</h5> </center></div><br>
<div class="row">
						<div class="col-xs-8 col-sm-8 col-md-8 text-left">
						<div class="receipt-left">
				
           <p>To.<br>THE NODAL OFFICER<br>PRADHAN MANTRI AAWAS YOJNA<br>DONGARGARH MUNICIPAL COUNCIL,DONGARGARH
		...
		<div class="col-xs-12 col-sm-12 col-md-12 text-center">
			...
			<div class="row">
                ...
                <b>CARPET AREA FF <span style="margin-left: 120px;"><?php echo $getuser2['PROPOSED_F_FLOOR_AREA']; ?></span></b>
                         ...
                         <li class="list-group-item">
                             <b>SANCTION AMOUNT<span style="margin-left: 110px;"><?php echo $sanctionamt;  ?></span></b>
                         </li>
                <li class="list-group-item">
                <b>AMOUNT<span style="margin-left: 185px;"><?php echo $amount_paid;  ?></span></b>
                </li>
			...
			<div class="footer text-center" >
				<b>OFFICE : Ward No. 2, Naka Para, beside trimmer Mill
                          <br> DONGARGARH(491445),DIST:-RAJNANDGAON<br>
                                 CONTACT : 8319968900,9826607119<br>
                           Email : Shanu13192@gmail.com</b>
			</div>
			<div class="notesheet">
